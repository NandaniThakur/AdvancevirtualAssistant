...
def wishMe():
    ...
    engine_speak("I am Jarvis ma'am. Please tell me how may I help you")           
...
def respond(voice_data):
    ...
    # search for music
    if there_exists(["play search music"]):
        search_term= voice_data.split("for")[-1]
    ...
    if  there_exists(["play music"]):
        music_dir = 'C:\\Users\\Harimira\\Music\\songs'
...
'''    
# these codes are fine but the thing is that it is not giving the exact output. if you can do it propery then please inform me.
      #check later  
    #13 screenshot
    if there_exists(["capture","my screen","screenshot"]):
        myScreenshot = pyautogui.screenshot()
        myScreenshot.save('C:\\Users\\Harimira\\Pictures\\Camera Roll') 
    ...
    if there_exists(["place"]): 
        ...
        url=urllib.request.urlopen('https://en.wikipedia.org/wiki/'+definition)   
        webbrowser.get().open(url)
        engine_speak("here you can check your place")
'''        
